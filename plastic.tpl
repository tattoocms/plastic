...
<title>[(site_name)] | [*pagetitle*]</title>
	...
	<link rel="stylesheet" href="[(base_url)]assets/templates/plastic/site.css" type="text/css" media="screen" />
...
<div id="content">
  ...
  <div id="sidebar"> <div>[[FlexSearchForm?FSF_showResults=0&amp;FSF_landing=`8`]]</div>
    <h3>Menu</h3>
	    <div id="menu">[!Wayfinder? &amp;startId=`0` &amp;level=`1`!] </div>
      <h3>NEW</h3>
[[NewsListing?   &amp;startID=`2` &amp;truncText=`leggi tutto` &amp;tpl=`rightnews`]] </div><div class="clear">&nbsp;</div>

<div id="footer">
  <div align="center">{{Footertext}}</div>
</div>
